...
The discretization process involved applying the equal_width_discretize() function to each column selected using lapply(). The resulting discrete values were then mapped back to the data set, data1, and displayed using head().
